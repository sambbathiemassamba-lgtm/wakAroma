...
//
// Connexion dédiée avec détection automatique local / OVH (même logique
// que stock.php), pour être certain d'interroger la même base que celle
// où les images sont ajoutées.
try {
